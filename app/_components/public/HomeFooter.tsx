...
<li><a href="#courses" className="hover:text-white">Nossos Cursos</a></li>
<li><a href="#" className="hover:text-white">Processo Seletivo</a></li>
<li><a href="/login/student" className="hover:text-white">Portal do Aluno</a></li>
</ul>
</div>
