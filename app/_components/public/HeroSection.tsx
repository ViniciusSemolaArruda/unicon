...
<img
src="https://images.unsplash.com/photo-1769284000746-6cbcc55c259f?auto=format&fit=crop&q=80&w=1400"
...
<Badge color="yellow" className="bg-[#FDBE00] text-[#111827] mb-6 inline-block">
...
<Button size="lg" variant="outline" className="text-white border-white hover:bg-white hover:text-[#2D74B2]">
Ver Cursos
</Button>
</div>
</motion.div>
